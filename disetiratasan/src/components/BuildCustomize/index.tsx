    ...
    return(
        <>
            <div className="flex flex-col items-center justify-center bg-white">
                <p className="text-center pt-5 m-3 font-bold md:text-3xl sm:text-2xl text-2xl">BUILD & CUSTOMIZE YOUR CAR</p>
                <br/>
                <div className="flex md:flex-row sd:flex-col flex-col md:text-lg sm:text-basic text-basic mb-10 md:mx-4">
                    ...
                    <Image className="md:pl-0 md:pr-1 pl-10 pr-10" src="/BuildCustomize-HomePage/jaguar-car.png" alt="..." width={500} height={500}></Image>
                </div>
                <div className="mt-3 flex md:flex-row sm:flex-col flex-col md:text-lg sm:text-base text-base md:mx-4">
                    <Image className="md:pl-10 pl-20 md:mb-0 sm:mb-2 mb-2" src="/BuildCustomize-HomePage/wheel.png" alt="..." width={280} height={280}></Image>
