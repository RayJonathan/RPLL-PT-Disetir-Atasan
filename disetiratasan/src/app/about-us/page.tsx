...
const AboutUs = () => {
    return (
        <div className="bg-disetircolour">
            <div className="bg-gradient-to-t from-disetircolour to-transparent h-screen" style={{ backgroundImage: `linear-gradient(to top, rgba(16, 29, 52, 1), rgba(0,0,255,0.2)), url('/About-Us-Images/bg-image.png')`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
            ...
            <div className="bg-gradient-to-b from-disetircolour to-transparent h-screen">
